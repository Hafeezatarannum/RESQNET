...
function SettingsPage() {
  ...
  // Functional Toggles State
  const [largeText, setLargeText] = useState(false);
  const [highContrast, setHighContrast] = useState(false);
  const [locationServices, setLocationServices] = useState(true);
  const [medicalSharing, setMedicalSharing] = useState(true);
  ...
  const [sosCountdown, setSosCountdown] = useState("3 Seconds");
              ...
              <div className="bg-card border border-border rounded-3xl p-6 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input type="text" defaultValue="Aarav Sharma" className="w-full h-12 px-4 bg-secondary/50 border border-border rounded-xl outline-none focus:border-primary font-medium" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-muted-foreground">Phone Number</label>
                    <input type="tel" defaultValue="+91 98765 43210" className="w-full h-12 px-4 bg-secondary/50 border border-border rounded-xl outline-none focus:border-primary font-medium" />
                  </div>
                </div>
              </div>
